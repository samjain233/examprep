<?php
session_start();
if(isset($_SESSION['testid']) && isset($_SESSION['uname']))
{
$con=mysqli_connect('','','','');
...
<html>
    ...
    <body>
        <div class="container">
            <div class="jumbotron">
                <center><h1>YOU HAD ALREADY TAKEN THE TEST</h1></center>
            </div>
        </div>
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <p class="style"><strong>STATUS : </strong>TEST ALREADY TAKEN</p>
            </div>
        </div>
        <form method="post">
            <center>
                <input type="submit" class="btn btn-primary" value="GO TO HOME PAGE" name="back">
                <input type="submit" class="btn btn-success" value="VIEW RESULT" name="vr">
            </center>
        </form>
